    ...
    <div class="mx-auto bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-end gap-4">
      ...
      <div class="space-y-1.5 flex-1">
        ...
        <select v-model="filter.line" 
          ...
          <option value="4">Line D</option>
          <option value="5">Line E</option>
          <option value="6">Line F</option>
          <option value="7">Line G</option>
          <option value="8">Line H</option>
          <option value="9">Line 300T</option>
          <option value="10">Line SP</option>
        </select>
      </div>
